...
def test_seed_graph_round_trips() -> None:
    """Validate the curated Phase 1 graph and its minimum useful size."""
...
@pytest.mark.parametrize("missing_field", ["tier", "species_evidence"])
